...
namespace PlayListAPI.Services
{
  ...
  public class CategoriaService : ICategoriaService
  {
    ...
    public CategoriaService(IMapper mapper, ICategoriaDAO dao)
    {
      _mapper = mapper;
      _dao = dao;
    }
    ...
    {
      Categoria? categoria = await _dao.GetCategoriaByIdAsync(id);
    ...
    {
      List<Video> videoCategoria = await _dao.GetVideosByCategoriaAsync(id);
    ...
    {
      List<Categoria> categorias = await _dao.GetCategoriasAsync();
    ...
    public async Task<ReadCategoriasDto?> UpdateCategoriaAsync(int id, UpdateCategoriasDtos updateCategoria)
    {
      ...
      await _dao.UpdateAsync(categoria);
    ...
    public async Task<Result> DeleteCategoriasAsync(int id)
    {
      ...
      await _dao.DeleteAsync(categoria);
